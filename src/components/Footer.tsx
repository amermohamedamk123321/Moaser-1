  ...
  return (
    <footer className="bg-primary text-primary-foreground">
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 py-5 text-xs text-primary-foreground/50 sm:flex-row">
          <p>© 2026 {t("footer.brandName")} | Powered by <a href="https://turabroot.com" target="_blank" rel="noopener noreferrer" className="group relative inline-block font-semibold text-primary-foreground/70 hover:text-primary-foreground transition-colors duration-300 after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-primary-foreground/40 hover:after:w-full after:transition-all after:duration-300">Turab Root</a></p>
          <p>{t("footer.rights")}</p>
          <button
